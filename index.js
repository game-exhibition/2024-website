		...
		let string = `
			<div id="game${id}" class="game-description">
				<div class="game-description-inner">
					...
					<div class="videos">
						<iframe allow="fullscreen;" class="trailer" src="${this.trailer}" allowfullscreen></iframe>
						<iframe allow="fullscreen;" class="trailer" src="${this.trailer}" allowfullscreen></iframe>
					</div>`;
...
const games = [
	new Game('TRIGGER',
		 ...
		 'trigger.jpg',
		 'https://youtube.com/embed/DDMbHJ7jCOc',
	...
	new Game('Forestale',
		 ...
		 'forestale.png',
		 'https://youtube.com/embed/W8TXLs0tJ5k',
	...
	new Game('Vier : Alter Code',
		 ...
		 'vier-alter-code.png',
		 'https://youtube.com/embed/6QciTixYj7I',
	...
	new Game('파란 우주선',
		 ...
		 'troublues-ship.png',
		 'https://youtube.com/embed/VbyR4QYwapg',
	...
	new Game('리듬테라피',
		 ...
		 '음약을 연주하며 마음을 치유해보자!',
		 'rhythm-therapy.png',
		 'https://youtube.com/embed/AGhzyTl7W0o',
	...
	new Game('FLORADO',
		 ...
		 'florado.jpg',
		 'https://youtube.com/embed/olwl3M8zKUo',
		 [],
		 "부스로 가서 플레이"),
	new Game('Noidi',
		 '양유빈, 김민수, 임승현, 최우주',
		 '우승자 제외 분쇄',
		 'noidi.png',
		 'https://youtube.com/embed/7-784zpqXxw',
	...
	new Game('Dormitory 2',
		 ...
		 'dormitory-2.png',
		 'https://youtube.com/embed/itkyap35V2E',
	...
	new Game('CG Fighter 23',
		 ...
		 'cg-fighter-23.png',
		 'https://youtube.com/embed/O8CAO46S1ug',
	...
	new Game('Cat Village',
		 ...
		 '위대한 고양이들의 귀여운 여정!',
		 'cat-village.png',
		 'https://youtube.com/embed/hQcItLCmloM',
	...
	new Game('초능력자를 키우는 완벽한 방법',
		 ...
		 'https://youtube.com/embed/okDtL9RGD_s',
	...
	new Game('GS-24',
		 ...
		 'gs-24.png',
		 'https://youtube.com/embed/P6Xiv89DWT0',
	...
	new Game('Cave Escape',
		 ...
		 'cave-escape.png',
		 'https://youtube.com/embed/d7wXDVqt97I',
	...
	new Game('Keep The Dragon',
		 ...
		 'keep-the-dragon.png',
		 'https://youtube.com/embed/gKKyIR63JpY',
	...
	new Game('스플래시',
		 ...
		 'splash.png',
		 'https://youtube.com/embed/YLpaARigBko',
	...
	new Game('KEEP THE SCREEN',
		 ...
		 'keep-the-screen.png',
		 'https://youtube.com/embed/XE-v2S7gUtA',
	...
	new Game('Potato',
		 ...
		 'potato.png',
		 'https://youtube.com/embed/9mo-sDMiGGc',
	...
	new Game('Candy Sugar Candy',
		 ...
		 'https://youtube.com/embed/Mbg_J9OrSXo',
	...
	new Game('비밀보장',
		 ...
		 'https://youtube.com/embed/n4X1G-Ofsuk',
	...
	new Game('기적재정의론',
		 ...
		 'https://youtube.com/embed/xS1THKPBbjE',
